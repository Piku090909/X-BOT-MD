...
const SUDO = process.env.SUDO || '918536881026';
...
const BOT_INFO = process.env.BOT_INFO || "𝛥𝐿𝛯𝛸 𝛲𝛪𝛫𝑈;𝛥𝐿𝛯𝛸 𝛲𝛪𝛫𝑈;https://telegra.ph/file/9403315158cbab1f395b1.jpg";
const URL = process.env.URL || "https://www.instagram.com/alex_piku__";
const AUDIO_DATA = process.env.AUDIO_DATA || "X BOT MD;ASWIN SPARKY;https://i.imgur.com/fVCRCYG.jpeg";
const STICKER_DATA = process.env.STICKER_DATA || "𝛥𝐿𝛯𝛸 𝛲𝛪𝛫𝑈;𝛥𝐿𝛯𝛸 𝛲𝛪𝛫𝑈";
